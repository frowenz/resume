  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Leading system design and engineering on computational art pieces created using in-house GAN and style transfer models, contributing 10k+ lines of Python and 5k+ lines of JavaScript to the art-research lab's codebase.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Constructing an application for research studies to compare the efficacy of techniques aimed at rapidly and accurately modeling an individual's color perception.}
      \resumeItemListEnd
    \resumeSubheading
      {Lexset.ai}
      {Brooklyn, NY}
      ...
      \resumeItemListStart
        \resumeItem{Added dozens of client-requested features to Blender-based 3D scene generator, facilitating the creation of photorealistic synthetic image datasets to improve downstream computer vision tasks.} \resumeItem{Secured the company's largest client by creating a dataset of 38,000 synthetic American Sign Language images.}
