  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        % \resumeItem{Wrote scripts to download movies and extract pose estimations, depth maps, and Canny edges from their frames. }
        % \resumeItem{Collaborating with designers to quickly transform Figma mockups into functional software prototypes.}
        \resumeItem{Engineering a web application with a highly customized map interface using React.js, Leaflet, Apache, and Node.js that receives thousands  monthly visitors.}
      \resumeItemListEnd
    \resumeSubheading
...
\resumeSubHeadingListStart
    ...
    \resumeItemListEnd
      ...
      %     \resumeItemListStart
      %       \resumeItem{Engineered a machine learning model to predict flight delays, achieving a high AUC of 0.74.}
      %       \resumeItemListEnd
