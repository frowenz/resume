...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {July 2024 -- Present}
      \resumeItemListStart
        \resumeItem{Integrating diffusion models into 3D-based synthetic image generation platform, facilitating the creation of large-scale datasets in the cloud for downstream computer vision tasks.}
        \resumeItem{Fine-tuning custom models to preserve key subject details, improving usability and photorealism of generated images.}
      \resumeItemListEnd
      ...
      \resumeItemListStart
        ...
        \resumeItem{Architected video rendering pipelines that autonomously generated thousands of hours of video content from massive datasets of conditioning data, utilizing  diffusion models, OpenCV, and GPU task allocation.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Added dozens of client-requested modules to Blender-based 3D scene generator.}
