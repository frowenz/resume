...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {July 2024 -- Present}
      \resumeItemListStart
        \resumeItem{Integrating diffusion models into 3D-based synthetic image generation platform, facilitating the creation of datasets in the cloud for downstream computer vision tasks.}
        \resumeItem{Applying latest diffusion model research to preserve key subjects, improving usability and realism of output images.}
      \resumeItemListEnd
      \resumeSubheading
      {Salavon Lab}
      {Chicago, IL}
